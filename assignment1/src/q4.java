...
public class q4 {
    public static void main(String arg[]) {
        ...
        for(i=0;i<t;i++) {
            ...
            for(j=0;j<ta;j++){
                TAs[j] = new TA(Scan.next(), Scan.next(), n);
            }
...
class TA {
    private String rollNo;
    private String name;
    private student[] mentees;
    private int studentFillIndex;
    private void setData(String rollSet, String nameSet){
        rollNo=rollSet;
        name=nameSet;
    }
    ...
    void setMentee(student studentSet){
        mentees[studentFillIndex]=studentSet;
        studentFillIndex++;
    }
    void printTA(){
        System.out.println(rollNo + " " + name);
    ...
    void printMentees(){
        int j=0;
        for(j=0;j<studentFillIndex;j++){
            mentees[j].printStudent();
        }
    }
    TA(String rollNoIn, String nameIn, int n){
        setData(rollNoIn,nameIn);
        mentees = new student[n];
    }
